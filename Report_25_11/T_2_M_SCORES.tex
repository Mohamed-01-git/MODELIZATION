...
\begin{figure}[H]
\includegraphics[scale=0.3]{plots/det/corr/CORR_jja_RR.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.25]{plots/det/corr/corr_T2M.png}
...
\begin{figure}[H]
\includegraphics[scale=0.3]{plots/det/rmse/rmse_djf_t2m.png}
\caption{3-months Rolling mean of RMSE in MENA Region for all centers DJF}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.3]{plots/det/rmse/rmse_jja_t2m.png}
...
\begin{figure}[H]
\includegraphics[scale=0.25]{plots/det/rmse/rmse_T2M.png}
...
\begin{figure}[H]
\includegraphics[scale=0.3]{plots/det/rsquared/rsquared_mam_t2m.png}
...
\begin{figure}[H]
\includegraphics[scale=0.3]{plots/det/rsquared/rsquared_djf_t2m.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.25]{plots/det/rsquared/rsquared_T2M.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/bs/bs_T2M_category.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/bs/bs_T2M_lead_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/prob/rela/rela_RR.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{plots/prob/rela/rela_diagram_t2m_djf.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/rps/rps_T2M.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/roc/roc_T2M_category.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/roc/roc_T2M_lead_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/prob/roc/roc_son_t2m_upper.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/rocss/rocss_T2M_category.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{plots/prob/rocss/rocss_T2M_lead_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/prob/rocss/rocss_mam_t2m_upper.png}
