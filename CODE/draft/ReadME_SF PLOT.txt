...
Inputs Required
The following datasets, already uploaded to Kaggle, are necessary for running this code:

Scores Data: /kaggle/input/scores
Moroccan Shapefile: /kaggle/input/morrocan-shape-file
Features
Interactive Plots: The code includes interactive features to simplify score analysis.
...
Inputs Required
The following datasets, available on Kaggle, are required:
...
Additional Notes
To run either notebook, ensure you have downloaded the required datasets.
For interactive features in the SF_PLOT_SCORES.ipynb, download the notebook and execute it locally using jupyter-notebook.
These codes address the key functionalities necessary for your analysis and have incorporated all the required fixes.
